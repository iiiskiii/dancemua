...
$view_provider = get_video_info($view['wr_link1']);
...
;
    ...
    <section id="bo_v_atc">
		...
		<?php if($view_provider['provider']){ ?>
		<div class="vidiom_vplayer" data-plyr-provider="<?php echo $view_provider['provider'];?>" data-plyr-embed-id="<?php echo $view_provider['video_id'];?>"></div>
		<!--div class="gall_img is_hover">
			<div class="img-item">
				<div class="vidiom_vplayer" data-plyr-provider="<?php echo $view_provider['provider'];?>" data-plyr-embed-id="<?php echo $view_provider['video_id'];?>"></div>
			</div>
		</div-->
...
if (typeof Plyr != "undefined") {
	const vidiom_vplayer = Plyr.setup( '.vidiom_vplayer', {
