...
include_once($board_skin_path.'/video.lib.php');
add_stylesheet('<link rel="stylesheet" href="https://cdn.plyr.io/3.7.8/plyr.css">', 0);
add_stylesheet('<script type="text/javascript" src="https://cdn.plyr.io/3.7.8/plyr.js"></script>', 1);
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con is_hover">
					<div class="gall_img is-round-post-img">
						<div class="img-item">
							<?php if($provider['provider']){ ?>
							<div class="vidiom_player" data-plyr-provider="<?php echo $provider['provider'];?>" data-plyr-embed-id="<?php echo $provider['video_id'];?>"></div>
							<?php }else{ ?>
							...
							<div class="post_content_overlay entry_meta">
								<a href="<?php echo $list[$i]['ca_name_href'] ?>"><span><?php echo $list[$i]['ca_name'];?></span></a>
							</div>
							<?php } ?>
						</div>
                    </div>
                    <div class="gall_text_href">
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit" style="height:<?php echo $line_sheight;?>px;">
						...
						<?php if($is_content){ ?>
                        <div class="bo_cnt" style="height:<?php echo $line_cheight;?>px;"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 150, '..'); ?></div>
						<?php } ?>
                    </div>
					<?php if($is_info){ ?>
                    <div class="gall_info">
