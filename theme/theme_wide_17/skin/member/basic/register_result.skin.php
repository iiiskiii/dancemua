...
$MBM_PART = "";
$MBM_PART = get_session('ss_check_MBM_PART');
set_session('ss_check_MBM_PART', '');
switch($MBM_PART){
	case "seller" 	 : $MBM_PART_NAME = "셀러"; break;
	case "supplyCom" : $MBM_PART_NAME = "공급사"; break;
	case "manager" 	 : $MBM_PART_NAME = "매니저"; break;
}
?>
...
<div class="container ety-mt margin-bottom-50 padding-top-50">
	<div id="reg_result">
		<h2><?php echo $MBM_PART_NAME ?><strong>회원가입</strong>이 완료되었습니다.</h2>
		...
		<div id="result_email">
			...
			<span>이메일 주소</span>
			<strong><?php echo $mb['mb_email'] ?></strong><br>
			<span>휴대폰 번호</span>
			<strong><?php echo $mb['mb_hp'] ?></strong>
		</div>
		<p>
		...
		<p>
			...
			아이디, 비밀번호 분실시에는 회원가입시 입력하신 아이디, 이메일 주소, 핸드폰번호를 이용하여 찾을 수 있습니다.
		</p>
