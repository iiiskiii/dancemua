...
<script type="text/javascript">
	jssor_1_slider_init = function() {
		...
		var jssor_1_SlideoTransitions = [
		  [{b:-1,d:0,o:-1},{b:0,d:1000,y:159,o:1}],
		  [{b:-1,d:0,o:-1},{b:1000,d:300,y:233,o:1}],
...
<div class="eye_con_1">
	<span class="eye_con_1_title">고객님의 발전은 저희의 성장입니다.</span><BR>
	<input type="button" value="홈페이지 포트폴리오" class="eye_bt_nover" onclick="">
	&nbsp;
	<input type="button" value="개발의뢰건" class="eye_bt_nover" onclick="">
	&nbsp;
	<input type="button" value="제작의뢰" class="eye_bt_over" onclick="">
</div>
