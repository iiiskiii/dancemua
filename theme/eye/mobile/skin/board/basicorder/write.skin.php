...
<tr height="50">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<?if($bo_table == 'ordermake'){?>

        <tr>
            <th scope="row"><label for="wr_email">이메일</label></th>
            <td><input type="email" name="wr_email" value="<?php echo $email ?>" id="wr_email" required class="frm_input email" maxlength="100"></td>
        </tr>

        <tr>
            <th scope="row"><label for="wr_1">휴대폰</label></th>
            <td><input type="text" name="wr_1" value="<?php echo $write['wr_1']; ?>" id="wr_1" required class="frm_input" maxlength="100"></td>
        </tr>
		<?}?>
