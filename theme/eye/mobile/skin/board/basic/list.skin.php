...
<div id="bo_list<?php if ($is_admin) echo "_admin"; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <thead>
        <tr>
            <th scope="col" class="b_list_ck">번호</th>
            <?php if ($is_checkbox) { ?>
            <th scope="col" class="b_list_ck">
                <label for="chkall" class="sound_only">현재 페이지 게시물 전체</label>
                <input type="checkbox" id="chkall" onclick="if (this.checked) all_checked(true); else all_checked(false);">
            </th>
            <?php } ?>
            <th scope="col">제목</th>
            <th scope="col" class="b_list_ck">글쓴이</th>
            <th scope="col">날짜</th>
            <th scope="col" class="b_list_ck">조회</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_name b_list_ck"><?php echo $list[$i]['name'] ?></td>
            <td class="td_date"><?php echo $list[$i]['datetime2'] ?></td>
            <td class="td_num b_list_ck"><?php echo $list[$i]['wr_hit'] ?></td>
