...
// ASK 추가 ## 20240826
/**
 * ## 회원레벨이 9 이하 또는 레벨이 없을때 사용됨
 * */
if ($member['mb_level'] < 8 || !$member['mb_level']){
    echo "<style>";
    echo " .btn_top.top.btn_bo_user {display:none;}"; ## 상단 메뉴
    echo " #bo_v > header {display:none;}"; ## 상단 제목
    echo " #bo_vc {display:none;}"; ## 하단 댓글
    echo "</style>";
}
 ...
 * */
echo "<style>";
echo " #bo_v {font-family: Nanum Gothic !important;padding:0 3em;}";
echo " #bo_list {padding:0 3em;}";
echo "</style>";
