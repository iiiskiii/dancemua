...
define('G5_MYSQL_USER', 'dancemua');
define('G5_MYSQL_PASSWORD', 'testtest^%$3211');
define('G5_MYSQL_DB', 'dancemua');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '0b0610843f400113af7849a28ed90325'); // 토큰 암호화에 사용할 키
